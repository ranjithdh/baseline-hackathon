...
const ExpertGuidanceCard = ({ targetScore }) => {
  return (
    <div style={{
      ...
      borderRadius: '24px',
      overflow: 'hidden',
      background: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('file:///Users/apple/.gemini/antigravity/brain/fa9c577f-ab0a-43f9-9bfe-3bd313206db4/media__1773387580265.png')`,
      backgroundSize: 'cover',
      backgroundPosition: 'center',
      border: '1px solid rgba(255, 255, 255, 0.1)',
      boxShadow: '0 8px 32px 0 rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(255, 255, 255, 0.05)',
      display: 'flex',
