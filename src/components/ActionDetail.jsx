  ...
  return (    <motion.div
    ...
    >
      ...
      <div className="absolute inset-0 z-0 opacity-30 pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-amber-100/20 rounded-full blur-[120px]" />
      </div>
      ...
      >
        ...
        >
          <div className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center group-hover:border-amber-500 transition-all mb-1 text-slate-400 bg-white/80 backdrop-blur-sm shadow-sm">
            <span className="material-symbols-outlined text-xl group-hover:text-amber-500 transition-colors">close</span>
          </div>
          <span className="text-slate-300 text-[6px] font-black uppercase tracking-[0.4em]">Close</span>
        </button>

        <header className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />
            <span className="text-[9px] font-black text-slate-400 uppercase tracking-[0.5em] font-['Space_Mono']">Analysis / Protocol_{category.toUpperCase()}</span>
          </div>
          <h1 className="text-5xl font-black text-slate-900 tracking-tighter uppercase leading-[0.9] font-['Outfit']">
            {item}
          </h1>
        </header>
        ...
        <div className="space-y-10">
          ...
          <section className="relative">
            <div className="absolute -left-4 top-0 bottom-0 w-[2px] bg-amber-500/20" />
            <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-4 font-['Space_Mono']">
              Scientific_Rationale
            </h3>
            <p className="text-slate-800 text-[15px] leading-relaxed font-bold font-['Inter']">
              {data.rationale}
            </p>
          </section>

          {/* Biological Impact - Technical Plate */}
          <section className="p-8 rounded-[40px] bg-slate-900 text-white shadow-2xl relative overflow-hidden group">
             <div className="absolute -top-10 -right-10 w-48 h-48 bg-amber-500/20 rounded-full blur-[60px] group-hover:bg-amber-500/30 transition-all duration-1000" />
             
             <div className="relative z-10">
                <div className="flex items-center gap-2 mb-6">
                    <span className="material-symbols-outlined text-amber-500 text-base">analytics</span>
                    <h3 className="text-[10px] font-black text-amber-500 uppercase tracking-[0.5em] font-['Space_Mono']">
                        Projected_Shift
                    </h3>
                </div>
                
                <p className="text-slate-300 text-[14px] leading-relaxed font-semibold mb-8 font-['Inter']">
                  {data.impact}
                </p>
                
                <div className="grid grid-cols-2 gap-3">
                  {data.biomarkers.map((marker, i) => (
                    <div key={i} className="px-4 py-3 rounded-2xl bg-white/5 border border-white/10 flex flex-col gap-1 transition-all hover:bg-white/10">
                      <span className="text-[7px] font-black uppercase tracking-widest text-slate-500">Marker</span>
                      <div className="flex items-center gap-2">
                        <div className="w-1 h-1 rounded-full bg-emerald-400 shadow-[0_0_10px_rgba(52,211,153,0.5)]" />
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-100 font-['Space_Mono']">{marker}</span>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <section className="p-8 rounded-[40px] bg-white border border-slate-100 shadow-sm relative overflow-hidden">
            ...
            <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-6 font-['Space_Mono']">
              Implementation_Specs
            </h3>
            
            <div className="flex items-start gap-5">
                <div className="w-14 h-14 rounded-3xl bg-amber-50 flex items-center justify-center flex-shrink-0 border border-amber-100 relative group">
                    <div className="absolute inset-0 bg-amber-500/10 rounded-3xl scale-0 group-hover:scale-100 transition-transform duration-500" />
                    <span className="material-symbols-outlined text-amber-600 text-2xl relative z-10">assignment_turned_in</span>
                </div>
                <div>
                   <p className="text-slate-600 text-[14px] leading-relaxed font-bold font-['Inter']">
                     {data.protocol}
                   </p>
        ...
        <div className="mt-16 mb-8 flex flex-col items-center gap-4">
            ...
            <span className="text-slate-300 text-[8px] font-black uppercase tracking-[0.8em] font-['Space_Mono']">Baseline Labs / BioDossier.v1</span>
            
            <button 
                onClick={onClose}
                className="w-full mt-4 py-6 rounded-[28px] bg-slate-900 text-white font-black text-[10px] tracking-[0.5em] uppercase hover:bg-black transition-all shadow-xl active:scale-[0.98]"
            >
