...
const ActionDetail = ({ item, category, onClose }) => {
  ...
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="absolute inset-0 z-50 bg-[#09090b] text-foreground font-main flex flex-col overflow-hidden"
    >
      <div className="w-full h-full flex flex-col relative">
        {/* Background Layer Patterns */}
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar relative z-10">
          ...
          <div className="px-6 sm:px-8 pt-8 pb-24">
